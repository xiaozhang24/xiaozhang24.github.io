...
$.fn.province_city_county = function(v_province,v_city,v_county){
    ...
    myarea.html("<select size=10 id='province' name='province' style='width: 110px;margin-right:10px;'></select>" +
    		"<select size=10 id='city' name='city' style='width: 110px;margin-right:10px;'></select>" +
    		"<select size=10 id='county' name='county' style='width: 110px'></select>");
	//分别获取3个下拉框
