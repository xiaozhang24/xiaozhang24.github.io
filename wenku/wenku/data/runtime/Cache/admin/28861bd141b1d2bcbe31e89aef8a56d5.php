...
<div class="pad_lr_10">
    ...
    <?php if(is_array($emot_list)): $i = 0; $__LIST__ = $emot_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="table_block">
        <div class="pad_10">
        <table>
            <tr>
              ...
              <td valign="top">
                    <table>
                        <tr>
                            <th align="right"><input type="radio" name="dirname" value="<?php echo ($val["dirname"]); ?>" <?php if($def_emot == $val['dirname']): ?>checked="checked"<?php endif; ?> /></th>
                            <td width="160"><?php if($def_emot == $val['dirname']): ?><span class="red">默认</span><?php else: ?><a href="<?php echo U('view/expression',array('dirname'=>$val['dirname'],'menuid'=>$menuid));?>" class="blue">设为默认</a><?php endif; ?></td>
                        </tr>
                        <tr><th align="right">表情文件夹：</th><td><?php echo ($val["dirname"]); ?></td></tr>
                        <tr><th align="right">表情名称：</th><td><?php echo ($val["name"]); ?></td></tr>
                        <tr><th align="right">表情提供者：</th><td><?php echo ($val["author"]); ?></td></tr>
                        <tr><th align="right">数量：</th><td><?php echo ($val["version"]); ?></td></tr>
                    </table>
              </td>
            </tr>
        </table>
