...
<tr>
    ...
    <td><textarea name="intro" id="intro" style="width:350px;height:100px;"class="txt" ><?php echo ($info["intro"]); ?></textarea></td>
...
<select size=10 class="J_cate_select iselect" data-pid="0" data-uri="<?php echo U('doc_cate/ajax_getsubcate');?>"  data-selected="<?php echo ($info["spid"]); ?>">
