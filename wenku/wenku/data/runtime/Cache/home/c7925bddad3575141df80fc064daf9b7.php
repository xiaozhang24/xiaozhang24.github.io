...
<?php if(is_array($cate)): $i = 0; $__LIST__ = array_slice($cate,0,8,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="menu_main job_hopping">
  <h2 class=" active fwb "><a style="display:block; width:248px; height: 52px; line-height: 52px; padding-left: 15px; " href="<?php echo U('doc/doclist',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?><span></span></a></h2>
...
<div id="focus_img">
		<div class="nbox">
		<?php $tag_doc_class = new docTag;$data = $tag_doc_class->lists(array('type'=>'lists','status'=>'5','cache'=>'0','return'=>'data',)); if(is_array($data['list'])): $i = 0; $__LIST__ = array_slice($data['list'],0,8,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="focus_box">
				<div class="pbox">
...
<div class="jpwd">
<div class="jptitle"><b>精品文档</b><div class="fr"><a href="<?php echo U('doc/doclist',array('c'=>'wytj'));?>">更多</a></div></div>
<div class="dochlist">

<?php $tag_doc_class = new docTag;$data = $tag_doc_class->lists(array('type'=>'lists','how'=>'rate','cache'=>'0','return'=>'data',)); if(is_array($data['list'])): $i = 0; $__LIST__ = array_slice($data['list'],0,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
<dt>
...
<div class="c-d-title"><h3>文档速递</h3>
<div class="fr">
<a href="<?php echo U('doc/doclist',array('c'=>'newdoc'));?>">更多</a>
</div>
</div>
<div class="dochlist" style="margin:0px 10px">
<?php $tag_doc_class = new docTag;$data = $tag_doc_class->lists(array('type'=>'lists','order'=>'add_time desc','cache'=>'0','return'=>'data',)); if(is_array($data['list'])): $i = 0; $__LIST__ = array_slice($data['list'],0,7,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
<dt>
<a href="<?php echo U('doc/doccon',array('id'=>$vo['id']));?>"><img src="<?php echo docimg($vo['model'],$vo['id']);?>" /></a>
<span class="icon <?php echo ($vo["ext"]); ?>"></span>
</dt>
...
<div class="catedoclist">
<div class="c-d-title"><h3 style="width:200px;float:left;">热门文档</h3>
...
<div class="dochlist" style="margin:0px 10px">
<?php $tag_doc_class = new docTag;$data = $tag_doc_class->lists(array('type'=>'lists','order'=>'hits desc','cache'=>'0','return'=>'data',)); if(is_array($data['list'])): $i = 0; $__LIST__ = array_slice($data['list'],0,7,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
<dt>
<a href="<?php echo U('doc/doccon',array('id'=>$vo['id']));?>"><img src="<?php echo docimg($vo['model'],$vo['id']);?>" /></a>
<span class="icon <?php echo ($vo["ext"]); ?>"></span>
