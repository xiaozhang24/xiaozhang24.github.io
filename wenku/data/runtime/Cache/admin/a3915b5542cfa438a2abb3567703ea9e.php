              ...
              <td valign="top">
                    <table>
                        <tr>
                            ...
                            <td width="160"><?php if($def_tpl == $val['dirname']): ?><span class="red">默认</span><?php else: ?><a href="<?php echo U('view/tpl',array('dirname'=>$val['dirname'],'menuid'=>$menuid));?>" class="blue">设为默认</a><?php endif; ?></td>
                        </tr>
