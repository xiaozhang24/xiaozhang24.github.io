...
<div class="ucright">
<div class="menuname">
<ul><li class="cur"><a href="#">账号绑定</a></li>
...
<div class="submenu">
<ul>
<li><a href="<?php echo U('ucenter/bangding');?>" class="cur">账号绑定</a></li>
...
<ul>
                    <?php if(is_array($oauth_list)): $i = 0; $__LIST__ = $oauth_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                        <div><img src="__PUBLIC__/images/oauth/<?php echo ($val["code"]); ?>/bind.png" /></div>
