...
<a	href="javascript:void(0);"	class="ic page-prev" title="上一页"></a>
	<input type="text"	class="page-input" style="font-weight:bold;float:left;margin-top:14px;" />
	<span class="page-count" style="font-weight:bold;float:left;">/&nbsp;<?php echo ($realstrcount); ?></span>
...
<span class="reader-download-price hidden-xs">
