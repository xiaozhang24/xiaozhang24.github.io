...
<div class="cleft" style="margin-top:20px;">
<div class="setinfo">
<div class="red_orange">填写文档信息</div>
<form id="info_form" action="<?php echo U('doc/doc_share',array('type'=>'add'));?>" method="post" onsubmit="return formcheck();" >
...
<tr>
    ...
    <td><input type="text" name="title" id="title" class="ins w300" value="<?php echo ($info["title"]); ?>" /><div id="J_upload_img-queue" class="uploadify-queue"></div></td>
  ...
  <tr>
    ...
    <input type="button" value="自动获取" id="J_gettags" name="tags_btn" class="wk-btn2 minibtns hidden-xs"></td>
    <td>标签请用半角逗号,隔开</td>
  </tr>
  <tr>
...
<select  class="J_cate_select iselect" data-pid="0" data-uri="<?php echo U('doc_cate/ajax_getsubcate');?>"  data-selected="">
    ...
    <td> <input type="submit" class="wk-btn2 g-n-btns" value="立即分享" /></td>
    <td>&nbsp;</td>
  </tr>
