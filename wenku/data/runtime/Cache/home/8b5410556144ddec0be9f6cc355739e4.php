...
<li><a href="<?php echo U('ucenter/setmail');?>" class="cur">邮箱绑定</a></li>
</ul>
...
<div class="setinfo">
<form id="info_form" action="<?php echo U('ucenter/yzmail');?>" method="post">
<table width="100%" border="0">
<input type="hidden" id="bind" name="bind" class="ins" value="<?php echo ($bind); ?>" />
<input type="hidden" id="yzsn" name="yzsn" class="ins" value="<?php echo ($yzsn); ?>" />
  <tr>
    <td width="80" align="right">邮箱：</td>
    <td><input type="text" id="email" name="email" class="ins" value="<?php echo ($info["email"]); ?>" />&nbsp;&nbsp;<font color=orange>填写邮箱而后验证</font></td>
    <td><font color=red>验证邮件的有效期为60秒</font></td>
  </tr>
  
    <tr>
    <td align="right"></td>
   <td> <input type="submit" id="yanzheng" class="wk-btn2 g-n-btns" value="验证邮箱" />&nbsp;&nbsp;&nbsp;&nbsp;<input style="margin-top:5px;" type="button" id="changemail" class="wk-btn2 g-n-canbtns" value="修改邮箱" /></td>
    <td>&nbsp;</td>
  </tr>
