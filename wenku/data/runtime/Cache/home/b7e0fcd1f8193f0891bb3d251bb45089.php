...
<div class="grayinfo" style="margin-top:10px;word-break:break-all;"><?php echo (msubstr(getuserintro($hisuid),0,50)); ?></div>
...
<div class="submenu">
<ul>
<li><a href="<?php echo U('member/fensi',array('uid'=>$hisuid));?>" class="cur">他/她的粉丝</a></li>
<li><a href="<?php echo U('member/guanzhu',array('uid'=>$hisuid));?>">他/她的关注</a></li>
...
<div class="topicimg"><a href="<?php echo U('member/mydoclist',array('uid'=>$vo['uid']));?>"><img src="<?php echo avatar($vo['uid'],'48');?>" /></a></div>
<div style="margin-left:65px;width:50%;word-break:break-all;">


<p><a href="<?php echo U('member/mydoclist',array('uid'=>$vo['uid']));?>"><?php echo (getusername($vo['uid'])); ?></a></p>

<p class="grayinfo"><?php echo (msubstr(getuserintro($vo['uid']),0,70)); ?></p>
...
<?php if($vo['focusstatus'] == 3): ?><div class="gzic" data-uri="<?php echo U('ucenter/delgz');?>" onClick="quxiaogz(<?php echo ($vo['uid']); ?>,this)">
<span  class="gz-icon xhgz-icon"></span>相互关注
</div>
<?php elseif($vo['focusstatus'] == 1): ?>
<div class="gzic" data-uri="<?php echo U('ucenter/delgz');?>" onClick="quxiaogz(<?php echo ($vo['uid']); ?>,this)">
<span  class="gz-icon ygz-icon"></span>已关注
</div>
<?php elseif($vo['focusstatus'] == 5): ?>
<div class="gzic" style="text-align:center;">你自己</div>
<?php else: ?>
<div class="gzic" data-uri="<?php echo U('ucenter/addgz');?>" onClick="guanzhu(<?php echo ($vo['uid']); ?>,this)">
<span  class="gz-icon jgz-icon"></span>加关注
</div><?php endif; ?>
</div>
