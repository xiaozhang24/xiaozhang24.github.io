...
<div class="ucright">
<div class="menuname">
<ul><li class="cur"><a href="#">我的下载</a></li>
...
<div class="fr">
<?php $tag_doctotalnum_class = new doctotalnumTag;$data = $tag_doctotalnum_class->lists(array('type'=>'lists','uid'=>$uid,'usertype'=>'down','order'=>'add_time desc','cache'=>'0','return'=>'data',));?><s>文档：</s><i><?php echo ($data["doc"]); ?>份</i><em>|</em>
...
<table width="100%" border="0" id="ucform">
  <tr>
    ...
    <th width="82" style="border-right:1px solid #e5e5e5;">积分</th>
    
    
  </tr>
   <?php $tag_doc_class = new docTag;$data = $tag_doc_class->lists(array('type'=>'lists','uid'=>$uid,'usertype'=>'down','order'=>'add_time desc','pagenum'=>'15','cache'=>'0','return'=>'data',)); if(is_array($data['list'])): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
