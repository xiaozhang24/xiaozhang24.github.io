//提示层的HTML
var onShowHtml = '<P class="noticeWrap"><B class="ico-focus"></B><SPAN class=txt-focus>$data$</SPAN></P>';
var onFocusHtml = '<P class="noticeWrap"><B class="ico-focus"></B><SPAN class=txt-focus>$data$</SPAN></P>';
